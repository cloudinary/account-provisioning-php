...
class UserGroupUsersResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'UserGroupUsersResponse';
    ...
    */
     ...
     * Sets users
     *
     * @param \Cloudinary\Provisioning\Model\UserGroupUser[]|null $users A list of user group users.
     *
     * @return $this
     */
