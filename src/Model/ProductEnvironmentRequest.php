...
class ProductEnvironmentRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ProductEnvironmentRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('baseSubAccountId', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getBaseSubAccountId(): ?string
    {
     ...
     * @return $this
     */
    public function setBaseSubAccountId(?string $baseSubAccountId): static
    {
        if (is_null($baseSubAccountId)) {
            throw new InvalidArgumentException('non-nullable baseSubAccountId cannot be null');
        }
