...
/**
 * AccessKeysResponse Class Doc Comment
 *
 * @package  Cloudinary\Provisioning
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AccessKeysResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AccessKeysResponse';
    ...
    {
        $this->setIfExists('accessKeys', $data ?? [], null);
    ...
    */
     ...
     * @return $this
     */
    public function setAccessKeys(?array $accessKeys): static
    {
        if (is_null($accessKeys)) {
            throw new InvalidArgumentException('non-nullable accessKeys cannot be null');
        }
     ...
     * Sets total
     *
     * @param int|null $total Total number of the access keys.
     *
     * @return $this
     */
