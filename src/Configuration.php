...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'CloudinaryProvisioningPHP/0.1.0 (PHP ' . PHP_VERSION . ')';
    ...
    {
        // Assuming we have only one variable
        $variableName = array_key_first($this->getHostSettings()[0]["variables"]);

        $this->host = $this->getHostFromSettings(0, [$variableName => $accountId]);
