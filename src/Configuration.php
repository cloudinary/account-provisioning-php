...
namespace Cloudinary\Provisioning;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.cloudinary.com/v1_1/provisioning/accounts/ACCOUNT_ID';

    /**
     * The CLOUDINARY_ACCOUNT_URL
     *
     * @var string
     */
    protected $cloudinaryAccountUrl = '';
     ...
     * @var string
     */
    protected $userAgent = 'CloudinaryProvisioningPHP/0.0.6 (PHP ' . PHP_VERSION . ')';
    ...
    /**
     * Sets the CLOUDINARY_ACCOUNT_URL
     *
     * @param string|null $cloudinaryAccountUrl the CLOUDINARY_ACCOUNT_URL
     *
     * @return $this
     */
    public function setCloudinaryAccountUrl(string $cloudinaryAccountUrl = null): static
    {
        if ($cloudinaryAccountUrl === null) {
            $cloudinaryAccountUrl = getenv('CLOUDINARY_ACCOUNT_URL');
        }

        $this->cloudinaryAccountUrl = $cloudinaryAccountUrl;

        $this->importCloudinaryAccountUrl();

        return $this;
    }

    /**
     * Parses and applies values from the CLOUDINARY_ACCOUNT_URL
     */
    protected function importCloudinaryAccountUrl(): void
    {
        if (empty($this->cloudinaryAccountUrl)) {
            return;
        }

        //TODO: validate

        $parts = parse_url($this->cloudinaryAccountUrl);

        if ($parts["scheme"] !== "account") {
            // Invalid/missing CLOUDINARY_ACCOUNT_URL
            return;
        }

        $this->setAccountId($parts["host"]);
    ...
    /**
     * Gets the CLOUDINARY_ACCOUNT_URL
     *
     * @return string The CLOUDINARY_ACCOUNT_URL
     */
    public function getCloudinaryAccountUrl(): string
    {
        return $this->cloudinaryAccountUrl;
    }
    ...
    public function setAccountId(string $accountId): static
    {
        ...
        $this->setHostAccountId($accountId);

        return $this;
    }

    /**
     * Sets the account Id in the host.
     *
     * Account ID comes after the api version in the host (v2/account_id).
     *
     * The regex searches for the v{number}/{string} part of the host and replaces the last part with the account Id.
     *
     * @param string $accountId The account Id to set.
     *
     * @return $this
     */
    public function setHostAccountId(string $accountId): static
    {
        $this->host = preg_replace('/(\/accounts)\/([\w\-]+)/', '${1}/' . $accountId, $this->host);
    ...
    {
        $report  = 'PHP SDK (Cloudinary\Provisioning) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 0.0.4' . PHP_EOL;
