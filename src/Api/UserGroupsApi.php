...
class UserGroupsApi
{
     ...
     *
     * @param  string $groupId The ID of the user group. (required)
     * @param  bool|null $extendedDetails Whether to only return extended (true) or basic information about the group (false).  **Default**: false. (optional)
    ...
    public function getUserGroup(
        string $groupId,
        ?bool $extendedDetails = null,
        string $contentType = self::contentTypes['getUserGroup'][0]
    ): \Cloudinary\Provisioning\Model\UserGroup
    {
        list($response) = $this->getUserGroupWithHttpInfo($groupId, $extendedDetails, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getUserGroupRequest($groupId, $extendedDetails, $contentType);
    ...
    {
        return $this->getUserGroupAsyncWithHttpInfo($groupId, $extendedDetails, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    ): Request
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $extendedDetails,
            'extended_details', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
    ...
    {
        list($response) = $this->getUserGroupsWithHttpInfo($extendedDetails, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getUserGroupsRequest($extendedDetails, $contentType);
    ...
    {
        return $this->getUserGroupsAsyncWithHttpInfo($extendedDetails, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
