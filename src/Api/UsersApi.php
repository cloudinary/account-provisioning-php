...
class UsersApi
{
     ...
     * @param  string[]|null $emails A list of up to 100 user Emails.  When provided, other parameters are ignored. (optional)
     ...
     * @param  string|null $sortOrder Control the order of returned users. **Possible values**: &#x60;desc&#x60; (default), &#x60;asc&#x60;. (optional)
     * @param  string|null $sortBy sortBy (optional)
    ...
    {
        list($response) = $this->getUsersWithHttpInfo($pending, $ids, $emails, $prefix, $subAccountId, $lastLogin, $from, $to, $unionType, $sortOrder, $sortBy, $page, $pageSize, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getUsersRequest($pending, $ids, $emails, $prefix, $subAccountId, $lastLogin, $from, $to, $unionType, $sortOrder, $sortBy, $page, $pageSize, $contentType);
    ...
    {
        return $this->getUsersAsyncWithHttpInfo($pending, $ids, $emails, $prefix, $subAccountId, $lastLogin, $from, $to, $unionType, $sortOrder, $sortBy, $page, $pageSize, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    ): Request
    {
        ...
        if ($emails !== null && count($emails) > 100) {
            throw new InvalidArgumentException('invalid value for "$emails" when calling UsersApi.getUsers, number of items must be less than or equal to 100.');
        }
